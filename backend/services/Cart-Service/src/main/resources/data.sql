...
insert into renting_request(user_id,status,created_at) values (4,2,'2021-1-11');
...
values(3,1,'2020-10-11','2020-10-20',1000,100);
insert into renting_request_vehicle(vehicle_id,renting_request_id,start_date,end_date,price,distance)
values(3,2,'2020-10-1','2020-10-20',1000,100);
insert into renting_request_vehicle(vehicle_id,renting_request_id,start_date,end_date,price,distance)
values(3,3,'2020-10-1','2020-10-20',1000,100);
insert into renting_request_vehicle(vehicle_id,renting_request_id,start_date,end_date,price,distance)
values(3,4,'2020-1-5','2020-1-15',1000,100);